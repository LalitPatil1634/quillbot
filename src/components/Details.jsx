        ...
        <div className="roundItem">
          ...
          >
            <div className="percent1">
              <span className="bigValue">{text1}% </span>
              <span className="smallValue">time saved</span>
            </div>
          </div>
        ...
        <div className="roundItem">
          ...
          >
            <div className="percent2">
              <span className="bigValue">{text2}+</span>
              <span className="smallValue">million</span>
            </div>
          </div>
        ...
        <div className="roundItem">
          ...
          >
            <div className="percent3">
              <span className="bigValue">{text3}%</span>
              <span className="smallValue">of students</span>
            </div>
          </div>
          <p className="someText">
