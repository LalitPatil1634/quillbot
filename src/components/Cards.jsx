    ...
    <div className="premiumOuterDiv">
      ...
      <div className="premiumTable">
        ...
        <div className="premSection">
          ...
          <div className="btnDivPrem">
            <button>Upgrade to Premium</button>
          </div>
          <p className="paraItems">
            ✔️ Unlimited words in the Paraphraser<span>🛈</span>{" "}
          </p>
          <p className="paraItems">
            ✔️ Standard, Fluency, Expand, Shorted, Formal, Simple, and Creative
            modes <span>🛈</span>{" "}
          </p>
          <p className="paraItems">
            ✔️ 4 synonym options <span>🛈</span>{" "}
          </p>
          <p className="paraItems">
            ✔️ Unlimited Freeze workds and phrases <span>🛈</span>{" "}
          </p>
          <p className="paraItems">
            ✔️ 6000 words in the summarizer <span>🛈</span>{" "}
          </p>
          <p className="paraItems">
            ✔️ Faster processing speed <span>🛈</span>{" "}
          </p>
          <p className="paraItems">
            ✔️ Advanced grammar rewrites <span>🛈</span>{" "}
          </p>
          <p className="paraItems">
            ✔️ Compare Modes (Desktop Only) <span>🛈</span>{" "}
          </p>
          <p className="paraItems">
            ✔️ Plagiarism Checker* <span>🛈</span>{" "}
          </p>
          <p className="paraItems">
            ✔️ Tone Detection <span>🛈</span>{" "}
          </p>
